...
{
    public static event Action<float> OnPickedUp;

    [Header("Loot")]
    [SerializeField] private float energyAmount = 10;
    ...
    public void Init(Vector3 from, Vector3 to, float? forcedSpeed = null, float? lootEnergy = null)
    {
